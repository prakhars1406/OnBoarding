...
func GetRouteInfo(datastoreClient factory.MongoClient) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		...
		routeInfo, err := datastoreClient.GetAllRouteInfo(merchantId)
		if err != nil {
			utility.HandleError(writer, http.StatusBadRequest, err)
		}  else {
			err := json.NewEncoder(writer).Encode(routeInfo)
			if err != nil {
